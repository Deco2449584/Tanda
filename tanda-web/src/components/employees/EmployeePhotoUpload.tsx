    ...
    <div>
      ...
      <div className="flex items-center gap-4">
        ...
        <input
          ...
          className="block w-full text-sm text-zinc-400 file:mr-3 file:rounded-lg file:border-0 file:bg-emerald-600 file:px-3 file:py-2 file:text-xs file:font-semibold file:text-white hover:file:bg-emerald-700 disabled:opacity-50"
        />
      </div>
    </div>
  );
