  ...
  return (
    <div className="space-y-5">
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm md:p-6">
        ...
        <p className="mt-1 text-sm text-slate-600">AWB {inspection.awbNumber}</p>
      ...
      <section className="grid gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:grid-cols-2 md:p-6">
        <DetailRow
          label="Conservation"
      ...
      {inspection.hasIssues && (
        <section className="rounded-2xl border border-amber-200 bg-amber-50 p-5 md:p-6">
          <h2 className="text-sm font-semibold text-amber-900">Issue description</h2>
