...
export function PortalHeader({ actions }: PortalHeaderProps) {
  return (
    <header className="border-b border-[#001A3F]/10 bg-white shadow-sm">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-4 md:px-8">
        <Link href="/portal" className="flex min-w-0 items-center gap-4">
          ...
          <div className="hidden min-w-0 border-l border-[#001A3F]/15 pl-4 sm:block">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#001A3F]/70">
              Client portal
            </p>
