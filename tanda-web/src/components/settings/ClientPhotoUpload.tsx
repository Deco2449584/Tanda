...
export function ClientPhotoUpload({
  ...
  return (
    <div>
      <label className="mb-1.5 block text-xs font-medium text-muted">Photo</label>
      <p className="mb-2 text-xs text-subtle">
        Optional site or company image shown on the client card.
      </p>
      <div className="flex items-center gap-4">
        <div className="flex h-16 w-16 shrink-0 items-center justify-center overflow-hidden rounded-xl bg-surface-hover ring-2 ring-zinc-700">
          {displayUrl ? (
            ...
            <Building2 className="h-7 w-7 text-subtle" aria-hidden />
          )}
        </div>
