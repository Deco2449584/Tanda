...
<body style="margin:0;padding:0;background-color:${BRAND.surface};font-family:'Segoe UI',Arial,Helvetica,sans-serif;">
    ...
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;border-radius:16px;overflow:hidden;border:1px solid ${BRAND.border};box-shadow:0 12px 40px rgba(0,26,63,0.12);">
          <tr>
            <td style="padding:32px 32px 24px;background:linear-gradient(160deg, ${BRAND.navy} 0%, ${BRAND.navyLight} 100%);text-align:center;">
          ...
          <tr>
            <td style="padding:28px 32px 8px;background:#ffffff;">
              ...
              <h1 style="margin:0 0 12px;font-size:24px;line-height:1.3;font-weight:700;color:${BRAND.text};">
                ${title}
              </h1>
              <p style="margin:0 0 8px;font-size:14px;color:${BRAND.subtle};">
                Hi ${firstName},
              </p>
              <div style="margin:0;font-size:15px;line-height:1.7;color:${BRAND.muted};">
                ${bodyHtml}
              </div>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding:8px 32px 28px;background:#ffffff;">
              <a href="${announcementUrl}" style="display:inline-block;padding:14px 28px;font-size:14px;font-weight:700;color:#ffffff;text-decoration:none;border-radius:10px;background:${BRAND.accent};">
                View in TimeTracker
              </a>
            </td>
          </tr>
