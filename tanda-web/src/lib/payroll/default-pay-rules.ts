...
export const DEFAULT_PAY_RULES: PayRules = {
  ...
  employmentTypes: [
    ...
    },
    {
      ...
      expenseAccountName: 'Contracting Expense',
      payableAccountCode: DEFAULT_PAYROLL_ACCOUNTING.wagesPayableAccountCode,
  ...
  /** Example values — Holly should replace these with the codes from her Xero file. */
  xero: {
    salesAccountCode: '200',
    salesTaxType: 'GST on Income',
    salesInvoicePrefix: 'SI',
    salesDescriptionTemplate: 'Labour charge — {period} — {site}',
    billsTaxType: 'GST on Expenses',
    billsInvoicePrefix: 'BILL',
    billsDescriptionTemplate: 'Wages — {period} — {staff}',
    billsContactMode: 'per_staff',
